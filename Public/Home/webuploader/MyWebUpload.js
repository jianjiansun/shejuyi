(function ($, window) {
    ...
    function initWebUpload(item, options) {
        ...
        var webuploaderoptions = $.extend({
            ...
            // swf文件路径
            swf: '/shejuyi/Public/Home/webuploader/Uploader.swf',
            // 文件接收服务端。
            server:  '/shejuyi/index.php/Home/Origanization/file_upload',
        ...
        uploader.on('uploadSuccess', function (file, response) {//上传成功事件
            ...
            if (response.state == "error") {
                ...
                target.find('#' + $(item)[0].id + file.id).find('span.webuploadstate').html('已上i传');
    ...
    $.fn.powerWebUpload = function (options) {
        ...
        if (typeof WebUploader == 'undefined') {
            var casspath = "/shejuyi/Public/Home/webuploader/webuploader.css";
            $("<link>").attr({ rel: "stylesheet", type: "text/css", href: casspath }).appendTo("head");
            var jspath = "/shejuyi/Public/Home/webuploader/webuploader.js";
