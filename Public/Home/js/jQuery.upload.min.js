(function(a) {
    a.fn.upload = function(D) {
        ...
        r.append(A.attr("data-num", B.num).attr("data-type", B.type)).append(d.attr("multiple", B.num > 1 ? "multiple" : false)).append(b.attr("name", B.inputname)).addClass(B.num > 1 ? "multiple" : "one").on("click", "li.add", function() { d.click() }).on("change", "input[type='file']", function(H) {
            ...
            C(i)
        }).on("click", "li.error", function(i) { z(a(i.currentTarget)) }).on("click", "svg.delete", function(i) { z(a(i.currentTarget).parent("li.success")) }).on("click", "svg.look", function(i) { if (D && typeof D == "function") { D(r, a(i.currentTarget).parent("li.success").data("url")) } }).on("mousedown", "li.success", function(I) {
            var i = a(I.target);
            j = a(this);
            var J = j.offset();
            var H = r.offset();
