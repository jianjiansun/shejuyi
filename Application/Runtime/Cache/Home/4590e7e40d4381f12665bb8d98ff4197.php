        ...
        <div class="col-md-12 column">
            <div class="row clearfix">
                ...
                <div class="col-md-2 column  perperson">
                    <h2>个人信息</h2>
                    <div>
                        <img id = "userImg" src="/Public/Home/imgs/personDl.jpg" alt="  ">
                        <!--用户图片更换-->
                                ...
                                <form id = "myForm" class="layui-form layui-form-pane basic-information" action="">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            ...
                                            <input name = "tel_code" value="" class="layui-input landlinePhoneNum" type="text" style="width: 42px;margin-right: 4px;" disabled="disabled" >
...
<script>
    ...
    $.post("/index.php/Home/Community/getoriganizationinfo", function (data) {

        var html = '';
        html =  '<div class="layui-form-item">\n' +
                '<label class="layui-form-label">机构名称</label>\n' +
                '<div class="layui-input-block">\n' +
                '<input name="origanization_name" disabled="disabled" required="" value="'+ data.sjy_origanization_name+'"  placeholder="请输机构名字" autocomplete="off" class="layui-input" type="text">\n' +
                '<a class="iconfont">&#xe600;</a>\n' +
                '</div>\n' +
                '</div>\n' +
                '<div class="layui-form-item">\n' +
                ...
                '<div  id="demo" style = "margin-bottom: 10px;">\n' +
                '<p>\n' +
                '<select name="province">'+ data.address_info.sjy_origanization_province_name +'</select>\n' +
                '<select name="city">'+ data.address_info.sjy_origanization_city_name +'</select>\n' +
                '<select name="area">'+ data.address_info.sjy_origanization_area_name +'</select>\n' +
                '</p>\n' +
                '</div>\n' +
                '<div id="show"></div>\n' +
                '</div>\n' +
                ...
                '<label class="layui-form-label">详细地址</label>\n' +
                '<div class="layui-input-block">\n' +
                '<input name="address" disabled="disabled" value="'+ data.address_info.sjy_origanization_address +'" required="" placeholder="请输入机构地址" autocomplete="off" class="layui-input" type="text">\n' +
                '<a class="iconfont" >&#xe600;</a>\n' +
                '</div>\n' +
                '</div>\n' +
                '<div class="layui-form-item">\n' +
                '<label class="layui-form-label">固定电话</label>\n' +
                '<input name = "tel_code" value="'+data.sjy_origanization_phone.split("-")[0]+'" class="layui-input landlinePhoneNum" type="text" style="width: 42px;margin-right: 4px;" >'+
                '<input name="phone" value="'+ data.sjy_origanization_phone.split("-")[1] +'" required="" placeholder="请输入固定电话号" autocomplete="off" class="layui-input landlinePhoneNum" type="text" style = "width: 355px;">\n' +
                '<a class="iconfont">&#xe600;</a>\n' +
                '<div class="id-remider">\n' +
                '<p class = "remider"></p>\n' +
                '</div>\n' +
                ...
                '<label class="layui-form-label">机构简介</label>\n' +
                '<div class="layui-input-block">\n' +
                '<textarea id = "textareaIntro" placeholder="'+ data.sjy_origanization_introduce +'" class="layui-textarea"></textarea>\n' +
                '</div>\n' +
                '</div>'
