                                    ...
                                    <div class="basic-information">
                                        <div class="img-box full">
                                            <section class=" img-section">
                                                ...
                                                <div class="case">
                                                    <div class="upload" data-type="png,jpg,jpeg,gif" action='/index.php/home/origanization/uploadoriganizationlogo' data-file='logo' data-num='1' id='case3'></div>
                                                </div>
                                            </section>
                                            <section class=" img-section">
                                                <p class="up-p">机构风采：<span class="up-span">上传一张风采</span></p>
                                                <div class="case">
                                                    <div class="upload" style='width:500px;height:300px' data-type="png,jpg,jpeg,gif" action='/index.php/home/origanization/uploadoriganizationimgs' data-file='file' data-num='1' id='case2'></div>
                                                </div>
                                            </section>
                                        </div>
                                    </div>
...
<script>
    ...
    //获得机构logo
    $.ajax({
        url: "/index.php/home/origanization/getoriganizationlogo",
        type: "get",
        data: {},
        dataType: "json",
        success: function(data) {
            if (data) {
                $("#case3").attr('data-value',data);
            } else {
                // $("#imghead").attr('src', '/Public/Home/imgs/a11.png')
            }
        }
