            ...
            <form role="form" class="deliver-form" id="upBox">
                <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                            ...
                            <div class="form-group">
                                ...
                                <select class="type" name="type" lay-verify="" id="type">
                                       <option value='0'>请选择</option>
                                       <option value='1'>申请项目</option>
                                       <option value='2'>当前项目</option>
                                       <option value='3'>历史项目</option>
                                </select>
                            </div>
                            <script type="text/javascript">
                                        $("#type").change(function () {  
                                            ...
                                            if(type == 1)
                                            {
                                                $("#project_goal").css('display','block'); //目的意义及目标
                                                $("#project_experience").css('display','block'); //已有基础及经验
                                                $("#project_way").css('display','block'); //具体方法及途径
                                                $("#project_rate_plan").css('display','none'); //实施进度安排
                                                $("#project_desired_result").css('display','block'); //项目预期效果
                                                $("#project_range").css('display','none'); //涵盖范围及规模
                                                $("#project_innovate").css('display','none');  //创新之处
                                                $("#plan_money").css('display','block');  //创新之处
                                            }else if(type==2)
                                            {
                                                $("#project_goal").css('display','block'); //目的意义及目标
                                                $("#project_experience").css('display','block'); //已有基础及经验
                                                $("#project_way").css('display','block'); //具体方法及途径
                                                $("#project_rate_plan").css('display','block'); //实施进度安排
                                                $("#project_desired_result").css('display','block'); //项目预期效果
                                                $("#project_range").css('display','block'); //涵盖范围及规模
                                                $("#project_innovate").css('display','block');  //创新之处
                                                $("#plan_money").css('display','block');  //创新之处
                                            }else if(type == 3){
                                                $("#project_goal").css('display','block'); //目的意义及目标
                                                $("#project_experience").css('display','none'); //已有基础及经验
                                                $("#project_way").css('display','block'); //具体方法及途径
                                                $("#project_rate_plan").css('display','none'); //实施进度安排
                                                $("#project_desired_result").css('display','block'); //项目预期效果
                                                $("#project_range").css('display','block'); //涵盖范围及规模
                                                $("#project_innovate").css('display','block');  //创新之处
                                                $("#plan_money").css('display','none');  //创新之处
                                            }
                                            else{
                                                layer.msg('请选择项目类别')
                                            }
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="formTextarea" disabled="true" name="origanization_desc" class="form-control ccccc" rows="3"><?php echo ($origanization_desc); ?></textarea>
                            </div>
                            <div class="form-group" id='plan_money' style="display:none">
                            ...
                            <div class="form-group" id='project_goal' style="display:none">
                            ...
                            <div class="form-group" id='project_experience' style="display:none">
                            ...
                            <div class="form-group" id='project_way' style="display:none">
                            ...
                            <div class="form-group" id='project_rate_plan' style="display:none">
                            ...
                            <div class="form-group" id='project_desired_result' style="display:none">
                            ...
                            <div class="form-group" id='project_range' style="display:none">
                            ...
                            <div class="form-group" id='project_innovate' style="display:none">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12" style="padding-right:0;padding-left:36px;">
                                                    ...
                                                    <div style="min-height:1px;line-height:160px;text-align:center;position:relative;" ontouchstart="">
                                                        <div class="cover-wrap" style="display:none;position:fixed;left:0;top:0;width:100%;height:100%;background: rgba(0, 0, 0, 0.4);z-index: 10000000;text-align:center;">
                                                            <div class="" style="width:700px;height:400px;margin:100px auto;background-color:#FFFFFF;overflow: hidden;border-radius:4px;">
                                                                ...
                                                                <div class="" style="height:56px;line-height:36px;text-align: center;padding-top:8px;">
                                                                    <button onclick="return false" id="clipBtn2" style="width:120px;height: 36px;border-radius: 4px;background-color:#ff8a00;color: #FFFFFF;font-size: 14px;text-align: center;line-height: 36px;outline: none;">确定</button>
                                                        ...
                                                        <div id="view2" style="width:214px;height:160.5px;" title="请上传 428*321 的项目主图"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div style="width: 100%;position: relative;">
                                    ...
                                    <div id="inputBox"><input type="file" title="请选择图片" id="file2" multiple accept="image/png,image/jpg,image/gif,image/JPEG" />点击选择图片</div>
                                    <div id="imgBox2"></div>
                                </div>
                            </div>
                            <div class="clearfix" style="width: 100%;text-align: center;padding-top:200px;">
                                <a href="javascript:;" id="deliverBtn2" type="submit" class="btn btn-default deliver-btn">提交</a>
                            </div>
                            <script type="text/javascript">
                                imgUpload({
                                    inputId: 'file2', //input框id
                                    imgBox: 'imgBox2', //图片容器id
                                    buttonId: 'deliverBtn2', //提交按钮id
