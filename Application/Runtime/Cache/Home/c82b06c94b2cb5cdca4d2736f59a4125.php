    ...
    <div class = "col-md-12" style = "background: #FFFFFF;padding: 30px;" >
        <form role="form" class = "deliver-form">
            ...
            <div class="form-group">
                ...
                <textarea id = "formTextarea" style = "resize: none;" name = "demand_describe" class="form-control ccccc" rows="3" ></textarea>
            </div>
...
<script>
    ...
    $("#deliverBtn").click(function () {
        ...
        var origanization_project_images = [];
        ...
        for( var i = 0; i < $(".filelist li").length; i++){
         ...
         /*  console.log($(".filelist li img").attr("src"));*/
           ...
           var imgSrc = $(".filelist li img").attr("src");
            ...
            origanization_project_images.push(imgSrc);
        ...
        console.log(origanization_project_images);
