    ...
    <div class = "container">
        <div class = "top">
            ...
            <ul class = "mainNav col-md-5">
                <li>
                    <a class = "" href="/index.php/Home/Origanization/send_project">发布项目</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container house-list">
        ...
        <div class="col-md-3 program-box">
            <div class="publish-program">
                <?php if(($figure == 1) and ($code > 0)): ?><a class="publish-btn" target='_blank' href="/index.php/Home/Origanization/send_project">发布项目</a><?php endif; ?>
                <?php if(($figure == 2) and ($code > 0)): ?><a class="deliverBtn" target='_blank' href="/index.php/Home/Community/send_project">发布项目</a><?php endif; ?>
...
<script>
    ...
    $(".more").click(function () {
        if(  flag ){
            $(".classNav").css({ "height" : "74px", "overflow" : "hidden" });
            flag = false;
        } else {
            $(".classNav").css({ "height" : "auto" });
            flag = true;
        }
    });
                        ...
                        $.get("/index.php/Home/Search/searchOriganization?type=" + type + "&search_body=" + text + "&page=" + obj.curr, function(data) {
                            ...
                            for (var i = 0; i < data.data.length; i++) {
                                ...
                                html += '<li>' +
                                    ...
                                    '<span class = "region">' + data.data[i].sjy_origanization_type_name + '</span>' +
                                    '</p>' +
                                    '<div class = "type">' +
                                    '<span class = "iconfont">&#xe61f;</span>' +
                                    '<span>' + data.data[i].address.sjy_origanization_city_name + '</span>-<span>' + data.data[i].address.sjy_origanization_area_name + '</span>' +
                                    '</div>' +
                                    '</div>' +
                                    '</a>' +
                                    '</li>';
