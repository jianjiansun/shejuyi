...
<script>
    ...
    $(".nav2").click(function() {
        $.post("/index.php/Home/Project/communityTenderProject?community_code=<?php echo ($id); ?>", function(data) {
            ...
            for (var i = 0; i < data.data.length; i++) {
                html += '<li class = "clearfix pro-li">' +
                    ...
                    '<div class = "left leftImg">' +
                    '<img src="' + data.data[i].main_imgs + '" alt="">' +
                    '</div>' +
                    '<div class = "left leftCon">' +
                    '<dl>' +
    ...
    $(".nav3").click(function() {
        $.post("/index.php/Home/Project/communityIngProject?community_code=<?php echo ($id); ?>", function(data) {

            var html = "";
            console.log(data);
            for (var i = 0; i < data.length; i++) {
                html += '<li class = "clearfix pro-li">' +
                    '<a href="/index.php/Home/Project/displayCommunityProject/id/' + data[i].project_info.sjy_id + '">' +
                    '<div class = "left leftImg">' +
                    '<img src="' + data[i].main_imgs + '" alt="">' +
                    '</div>' +
                    '<div class = "left leftCon">' +
                    '<dl>' +
                    ...
                    '<dl>' +
                    '<dt>执行机构</dt>' +
                    '<dd>' + data[i].project_info.sjy_community_project_origanization_name + '</dd>' +
                    '</dl>' +
                    '<dl>' +
                    '<dt>服务对象</dt>' +
                    '<dd>' + data[i].project_info.sjy_community_project_service_area + '</dd>' +
                    '</dl>' +
                    '</div>' +
                    '</a>' +
                    '</li>';
    ...
    $(".nav4").click(function() {
        $.post("/index.php/Home/Project/communityCompleteProject?community_code=<?php echo ($id); ?>", function(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                html += '<li class = "clearfix pro-li">' +
                    ...
                    '<dl>' +
                    '<dt>项目名称</dt>' +
                    '<dd>' + data[i].project_info.sjy_community_project_title + '</dd>' +
                    '</dl>' +
                    '<dl>' +
                    '<dt>执行机构</dt>' +
                    '<dd>' + data[i].project_info.sjy_community_project_origanization_name + '</dd>' +
                    ...
                    '<dl>' +
                    '<dt>执行周期</dt>' +
                    '<dd>' + data[i].project_start_time +' ~ '+ data[i].project_end_time + '</dd>' +
                    '</dl>' +
                    '<dl>' +
                    '<dt>评分</dt>' +
                    '<dd>' +
