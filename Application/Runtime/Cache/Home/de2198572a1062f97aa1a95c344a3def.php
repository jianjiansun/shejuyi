    ...
    $.post("/index.php/Home/Project/communityTenderProject", function (data) {
        ...
        for(var i = 0; i < data.data.length; i++){
            html += '<tr>\n' +
                ...
                '<td><a href="/index.php/Home/Project/displayCommunityProject/id/'+data.data[i].sjy_id+'">查看</a><br>' +
                    '<a id = "'+data.data[i].sjy_id +'" class = "intention-organization" href="javascript:;">意向机构</a></td>\n' +
                '\n' +
                '</tr>';
        }
