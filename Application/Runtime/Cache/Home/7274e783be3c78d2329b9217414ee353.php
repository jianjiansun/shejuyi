...
<script>
    ...
    $(".addSearchBtn").click(function () {
        ...
        console.log(phone);
        $.ajax({
            url: "/index.php/Home/Community/searchNameByPhone",
            type: "POST",
            data: {
                phone : phone
            },
    ...
    $(".inviteBtn").click(function () {
        ...
        $.ajax({
            url: "/index.php/Home/Community/doAddStaff",
            type: "POST",
            data: {
                phone : phone
            },
            ...
            success: function (data) {
                ...
                if(data.state == 1) {
                    ...
                    var html = '';
                    html += '<tr>' +
                            '<td>'+ data.user_info.sjy_community_user_real_name +'</td>' +
                            '<td class = "sjy_community_login_id">'+ data.user_info.sjy_community_login_id+'</td>' +
                            '<td>'+ data.user_info.sjy_community_user_email +'</td>' +
                            '<td>' +
