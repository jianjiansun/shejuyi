    ...
    <div class="container" style="margin-bottom: 40px;">
        ...
        <div class="col-md-12" style="background: #FFFFFF;padding: 30px;">
            <form role="form" class="deliver-form" id="upBox">
                ...
                <div class="form-group">
                    <label for="name">征集周期</label>
                    <input name="collect_start_time" placeholder="请选择征集周期" type="text" id="test2" value="" style="width: 192px;">
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    imgUpload({
        ...
        upUrl: '/index.php/Home/Community/doSendProject', //提交地址
