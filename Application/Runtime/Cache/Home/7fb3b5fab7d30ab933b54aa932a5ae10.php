                            ...
                            <div class="layui-tab-item layui-show">
                                ...
                                <form class="layui-form  personal-information" action="" id = "myForm" >
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input required="" disabled="disabled" value="" class="layui-input" type="text">
                                           <!-- <a class="iconfont" lay-event="edit">&#xe600;</a>-->
...
$.ajax({
        ...
        success: function (data) {
            ...
            html += '<div class="layui-form-item">' +
                    '<label class="layui-form-label">姓名</label>\n' +
                    '<div class="layui-input-block">\n' +
                    '<input name="realname" value="'+ data.sjy_origanization_user_real_name +'" disabled="disabled" class="layui-input" type="text">\n' +
                    '</div>\n' +
                    '</div>\n' +
                    '<div class="layui-form-item">\n' +
                    '<label class="layui-form-label">手机号</label>\n' +
                    '<div class="layui-input-block">\n' +
                    '<input name="phone" value="'+ data.sjy_origanization_login_id +'" disabled="disabled" class="layui-input testPhoneNum" type="text">\n' +
                    '<a class="iconfont">&#xe600;</a>\n' +
                    '<div class="id-remider">\n' +
                    '<p class = "remider"></p>\n' +
                    '</div>\n' +
                    ...
                    '<label class="layui-form-label">微信号</label>\n' +
                    '<div class="layui-input-block">\n' +
                    '<input name="wechat" value="'+ data.sjy_origanization_user_wechat +'" disabled="disabled" class="layui-input" type="text">\n' +
                    '<a class="iconfont">&#xe600;</a>\n' +
                    '</div>\n' +
                    '</div>\n' +
                    '<div class="layui-form-item">\n' +
                    '<label class="layui-form-label">邮箱</label>\n' +
                    '<div class="layui-input-block">\n' +
                    '<input name="email" value="'+ data.sjy_origanization_user_email +'" disabled="disabled" class="layui-input testMailBox" type="text">\n' +
                    '<a class="iconfont">&#xe600;</a>\n' +
                    '<div class="id-remider">\n' +
                    '<p class = "remider"></p>\n' +
                    '</div>\n' +
                    ...
                    '<label class="layui-form-label">所在机构</label>\n' +
                    '<div class="layui-input-block">\n' +
                    '<input required="" disabled="disabled" value="'+ data.sjy_origanization_name +'" class="layui-input" type="text">\n' +
                    '</div>\n' +
                    '</div>';
