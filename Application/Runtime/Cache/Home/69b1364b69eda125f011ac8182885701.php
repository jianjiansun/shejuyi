    ...
    <div class="headLogin">
        ...
        <div class="right person">
            <div class="dropdown pull-right">
                <?php if(($isidentify == 1) and ($code > 0) and ($figure == 1)): ?><a class = "myOwnIndex" href="/index.php/home/Home/displayOriganizationHome"><?php echo ($origanization_name); ?></a><?php endif; ?>
                <?php if(($isidentify == 1) and ($code > 0) and ($figure == 2)): ?><a class = "myOwnIndex" href="/index.php/home/Home/displayCommunityHome"><?php echo ($community_name); ?></a><?php endif; ?>
    ...
    <div class="container" style="margin-bottom: 40px;">
        <div class="detailBox">
            <div class="detail-bottom">
                ...
                <div class="col-md-6">
                <?php if(($figure == 2) and ($code > 0)): ?><a id="inviteOr" class="deliverBtn" href="javascript:;">邀请做项目</a><?php endif; ?>
                <?php if(($figure == 1) and ($code > 0)): ?><a class="deliverBtn" target='blank' href="/index.php/home/Origanization/send_project">发布项目</a><?php endif; ?>
                <?php if(($figure == 2) and ($code > 0)): ?><a class="deliverBtn" target='blank' href="/index.php/home/Community/send_project">发布项目</a><?php endif; ?>
                </div>
...
<script>
    ...
    $.post("/index.php/home/home/getOriganizationInfo?id=<?php echo ($id); ?>", function(data) {
        ...
        var html = "";
        console.log(data);
        if(data.sjy_origanization_introduce!=null)
        {
            var introduce = data.sjy_origanization_introduce;
        }else{
            var introduce = '';
        }
        html += '<div class = "detail-item">' +
            '<span  class = "left">机构简介</span>' +
            '<p  class = "left">' + introduce + '</p>' +
            '</div>' +
            '<div class = "detail-item">' +
            '<span class = "left">服务领域</span>' +
            ...
            '<div class = "detail-item">' +
            '<span  class = "left">机构风采</span>' +
            '<p><img class = "orDetail-img" src="' + data.origanization_images + '" alt=""></p>' +
            '</div>';
