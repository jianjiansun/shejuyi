                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id = "login">
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group-border">
                                <input type="text" class="form-input phoneNum" id="username" placeholder="请输入手机号">
                                <input type="password" class="form-input pswNum" id="password" placeholder="请输入密码">
                            </div>
                    ...
                    <div class="tab-pane fade" id = "register" >
                        <form  class="form-horizontal" role="form">
                            <input type='hidden' value='2' />
                            <div class="form-group-border">
                                <input type="text" class="form-input phoneNum" id="Rusername" placeholder="请输入手机号">
                                <input type="password" class="form-input pswNum" id="Rpassword1" placeholder="请输入密码">
                                <input type="password" class="form-input pswNum" id="Rpassword2" placeholder="请再次输入密码">
                            </div>
                            <div class="form-group">
                                <p class = "remider"></p>
                            </div>
...
<script>
    ...
    $("#login-btn").click(function () {
        ...
        $.ajax({
            ...
            data: {type : 1, phone : $("#username").val() , password : $("#password").val()},
            type : "post",
            dataType : "json",
                ...
                <div id="myTabContent2" class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id = "login2">
                        <form class="form-horizontal" role="form">
                            ...
                            <input type='hidden' value='2' />
                            <div class="form-group-border">
                                <input type="text" class="form-input phoneNum" id="username2" placeholder="请输入手机号">
                                <input type="password" class="form-input pswNum" id="password2" placeholder="请输入密码">
                            </div>
                            <div class="form-group">
                                <p class = "remider"></p>
                            </div>
                    ...
                    <div class="tab-pane fade" id = "register2" >
                        <form  class="form-horizontal" role="form">
                            <input type='hidden' value='2' />
                            <div class="form-group-border">
                                <input type="text" class="form-input phoneNum" id="Rusername2" placeholder="请输入手机号">
                                <input type="password" class="form-input pswNum" id="Rpassword21" placeholder="请输入密码">
                                <input type="password" class="form-input pswNum" id="Rpassword22" placeholder="请再次输入密码">
                            </div>
                            <div class="form-group">
                                <p class = "remider"></p>
                            </div>
...
<script>
    ...
    $("#login-btn2").click(function () {
        ...
        $.ajax({
            url : "/index.php/Home/Login/dologin",
            data: {type : 2, phone : $("#username2").val() , password : $("#password2").val()},
            type : "post",
            dataType : "json",
            success : function (data) {
    ...
    $("#register-btn2").click(function () {
        ...
        if( !($("#Rpassword21").val() == $("#Rpassword22").val()) ){
