...
<div class="container">
    <div class="row clearfix">
        ...
        <h4 class = "plateTit">社区信息</h4>

        <div class="col-md-9 column box-padding">
            <h3 class = "organizeTit"><?php echo ($community_info[0]["city"]); echo ($community_info[0]["area"]); echo ($community_info[0]["sjy_community_name"]); ?></h3>
            <div class="layui-carousel" id="test1">
                <div carousel-item>
                    <?php if(is_array($community_images)): foreach($community_images as $key=>$val): ?><img src = "/shejuyi<?php echo ($val["sjy_community_images"]); ?>" /><?php endforeach; endif; ?>
                </div>
            </div>
		  <script>
                    ...
                    <ul class = "detail col-md-8">
                        <li>
                           <span>地址</span>:<span><?php echo ($community_info[0]["city"]); echo ($community_info[0]["area"]); echo ($community_info[0]["street"]); echo ($community_info[0]["sjy_community_address"]); ?></span><br />
                           <span>联系电话</span>:<span><?php echo ($community_info[0]["sjy_community_phone"]); ?></span><br />
                        </li>
                    </ul>
...
<div class = "container">
    ...
    <?php if(is_array($now_project)): foreach($now_project as $key=>$val): ?><div class = "col-md-6 column">
            <div class = "col-md-5 column">
		<a href="/shejuyi/index.php/Home/Origanization/projectinfo/id/<?php echo ($val["sjy_id"]); ?>">
                <img src="/shejuyi<?php echo ($val["project_image"]); ?>" alt="">
		</a>
            </div>
            <div class = "col-md-7 column">
               <a href="/shejuyi/index.php/Home/Origanization/projectinfo/id/<?php echo ($val["sjy_id"]); ?>"> <h3 class = "organizeTit"><?php echo ($val["sjy_community_project_title"]); ?></h3></a>
                <p>服务对象:<?php echo ($val["sjy_community_project_service_area"]); ?></p>
                <p>需求:<?php echo ($val["sjy_community_project_demand"]); ?></p>
                <div>
                    <p class = "right">
                        <a class= "detailBtn" href="/shejuyi/index.php/Home/Origanization/projectinfo/id/<?php echo ($val["sjy_id"]); ?>">
                            了解详情
                        </a>
                        <a class= "detailBtn" href="/shejuyi/index.php/Home/Origanization/projectinfo/id/<?php echo ($val["sjy_id"]); ?>">
                            联系项目
            ...
            <div class="carousel slide" id="carousel-798614">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img alt="" src="/shejuyi/Public/Home/imgs/banner.jpg" />
