        ...
        $.post("/index.php/Home/Project/ingProject", function(data){
            ...
            for(var i = 0; i < data.length; i++){
                ...
                html4 += '<tr>' +
                    ...
                    '<td><a href="/index.php/Home/Project/displayCommunityProject/id/'+data[i].project_id+'">查看进度</a> <a href="/index.php/Home/Project/displayCommunityProject/id/'+data[i].project_id+'">详情</a> <br><a class = "projectBook" id = "'+ data[i].project_id +'" href="javascript:;">项目书</a></td>' +
                    '</tr>';
            }
            $("#tbody4").html(html4);
