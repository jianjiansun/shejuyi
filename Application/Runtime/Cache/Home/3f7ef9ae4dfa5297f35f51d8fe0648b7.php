...
<body>
<!-- 4.1 邀请我 实现发送项目书-->
<div class="layui-layer-shade" id="shade1" times="1" style="z-index: 19891014;display: none; background-color: rgb(0, 0, 0); opacity: 0.3;"></div>
<div class="layui-layer layui-layer-dialog" id="layer3" type="dialog" times="3" showtime="0" contype="string" style="z-index: 19891017;display: none; width: 400px; height: 300px; top: 165px; left: 751.5px;">
    <div class="layui-layer-title" style="cursor: move;">信息</div>
    <div id="layer4" class="layui-layer-content" style="height: 258px;">
        <p>选择发送的项目书</p><br>
        <button type="button" class="layui-btn deliverBox or-deliverBtn" id="test1">
