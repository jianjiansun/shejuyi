                        ...
                        <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                            <ul class="layui-tab-title">
                                ...
                                <li id="biding" lay-id="b">投标中
                                    <?php if($sendNum > 0): ?><span class="layui-badge"><?php echo ($sendNum); ?></span><?php endif; ?>
                                </li>
                                <li id="starting" lay-id="c">待开始
                                    <?php if($waitStatNum > 0): ?><span class="layui-badge"><?php echo ($waitStatNum); ?></span><?php endif; ?>
                                </li>
                                <li id="going" lay-id="d">进行中
                                    <?php if($ingNum > 0): ?><span class="layui-badge"><?php echo ($ingNum); ?></span><?php endif; ?>
                                </li>
                                <li id="apllyFinishProject" lay-id="e">结项申请
                                    <?php if($applyEndNum > 0): ?><span class="layui-badge"><?php echo ($applyEndNum); ?></span><?php endif; ?>
                                </li>
