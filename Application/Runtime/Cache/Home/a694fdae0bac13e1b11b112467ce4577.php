         ...
         for(var i = 0; i < data.data.length ; i ++) {
            var href = '/index.php/Home/Home/displayOriganizationHome/id/'+data.data[i].sjy_id;
             ...
             html+=  '<li>' +
                     ...
                     '<div class = "type">' +
                     '<span class = "iconfont">&#xe61f;</span>' +
                     '<span>'+data.data[i].address.sjy_origanization_city_name+'</span>-<span>'+data.data[i].address.sjy_origanization_area_name+'</span>-<span>'+  data.data[i].address.sjy_community_street_name +'</span>' +
                     '</div>' +
                     '</div>' +
                     '</a>'+
                     '</li>';
