...
<div class="container house-list">
    <div class="row clearfix  col-md-9">
        <ul class="nav navbar-nav classNav">
            ...
            <li>
                <a href="javascript:;">为老服务</a>
            </li>
            <li>
                <a href="javascript:;">青少年服务</a>
            </li>
            <li>
                <a href="javascript:;">医务服务</a>
            </li>
            <li>
                <a href="javascript:;">司法矫正</a>
            </li>
            <li>
                <a href="javascript:;">心理服务</a>
            </li>
            <li>
    ...
    $.post("/index.php/home/origanization/getprojectlist/page/1", function (data) {
        ...
        for(var i = 0; i < data.data.length ; i ++) {
            html+=  '<li>' +
                    ...
                    '</a>'+
                    '</li>';
>>>>>>> 5f1e43ac95b56e4c72580eb0aff560d1eb922e82
...
>>>>>>> 5f1e43ac95b56e4c72580eb0aff560d1eb922e82
    ...
    var search = function () {
        ...
        $.ajax({
            url: "/index.php/home/Project/searchCommunityProject",
            type: "POST",
            data: {
                type: type,
                text: text
