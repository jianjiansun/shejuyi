    ...
    $.post("/index.php/Home/Origanization/getprojectlist/page/1", function (data) {
        ...
        for(var i = 0; i < data.data.length ; i ++) {
            html += '<li class="col-md-4 column">' +
                    ...
                    '</p>' +
                    '<div class="col-md-6 column" style = "padding: 0;">' +
                    '<img  src="'+ data.data[i].project_image_path +'" alt="" >' +
                    '</div>' +
                    '<div class="col-md-6 column house-list-info">' +
                    '<p class = "where">' +
            ...
            html+=  '<li>'+
                    ...
                    '<img  src="'+data.data[i].sjy_origanization_logo_img_path+'" alt="" style = "height: 200px;width: 200px;border: 1px solid #cccccc;">'+
                    '</div>'+
                    '<div class="col-md-6 column house-list-info" style="padding-top: 56px;">'+
                    '<p class = "where">'+
                    '<span class = "region region1">'+data.data[i].sjy_origanization_name+'</span>'+
                    '</p>'+
                    '<p class = "where">'+
