...
<div class="layui-layout layui-layout-admin" id="layui_layout">
	...
	<div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
		...
		<ul class="layui-nav layui-nav-tree">
			<li class="layui-nav-item layui-this">
				<a href="javascript:;" data-url="/index.php/Admin/Index/main">
			...
			<li class="layui-nav-item">
				...
				<dl class="layui-nav-child">
					<dd>
                        <a href="javascript:;" data-url="/index.php/Admin/Admin/adminlist">
                    ...
                    <dd>
                        <a href="javascript:;" data-url="/index.php/Admin/Admin/adminadd">
		...
		<div class="layui-tab layui-tab-card larry-tab-box" id="larry-tab" lay-filter="demo" lay-allowclose="true">
			...
			<div class="layui-tab-content" style="min-height: 150px; ">
				<div class="layui-tab-item layui-show">
					<iframe class="larry-iframe" data-id='0' src="/index.php/Admin/Index/main"></iframe>
				</div>
			</div>
		</div>
	</div>
